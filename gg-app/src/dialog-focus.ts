...
export function useDialogFocus(
  ...
  // Capture the opener during the first render, before children commit: an
  // `autoFocus` child takes focus at commit, ahead of any effect, and focus
  // would otherwise return to <body> on close. (Kleio fork fix, kept across
  // upstream syncs.)
