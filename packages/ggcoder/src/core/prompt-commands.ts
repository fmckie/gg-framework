...
const CLAUDE_MD_RESTART_NOTICE = IS_GG_APP
  ...
  : "> ⚠️ The project context file was created/updated. Kleio Coder loads it at startup, so **exit and restart Kleio Coder** (`/quit` then run `kleio-coder` again) before continuing. Without a restart, I won't see the new context.";
